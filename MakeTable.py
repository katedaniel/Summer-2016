...
filepath = "/Users/LBarbano/Desktop/QP_Data/Trapped_Orbital_Integrator-master_(theta=15)" #filepath to tar files
...
dataFilePath1 = "/Users/LBarbano/Github/Summer-2016/table1_theta=15.txt"
np.savetxt(dataFilePath1, table1.astype(str), delimiter = " ",fmt='%s')  

dataFilePath2 = "/Users/LBarbano/Github/Summer-2016/table2_theta=15.txt"
